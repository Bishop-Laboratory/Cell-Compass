...
`r paste("PC1: ", round(var_explained[1] * 100, digits = 2), "%", sep = "")`  
`r paste("PC2: ", round(var_explained[2] * 100, digits = 2), "%", sep = "")`  
`r paste("PC3: ", round(var_explained[3] * 100, digits = 2), "%", sep = "")`
